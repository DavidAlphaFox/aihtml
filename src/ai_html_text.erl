%%%-------------------------------------------------------------------
%%% @doc The canonical text representation, shared by every aihtml engine.
%%%
...
%%
%% This is the only implementation; every engine's scanner, parser, ast and
%% compiler go through it rather than carrying a private copy.
...
%% these being binaries -- including the module_name/2 of each engine, which
